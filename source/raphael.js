...
(function () {
    ...
    if (R.vml) {
        ...
        elproto.setBox = function (params, cx, cy) {
            ...
            switch (this.type) {
                case "circle":
                // JD: attr.cx and attr.cy sometimes coming out as NaN
                // I have not investigated further, but Raphael's own
                // fallback is to use 0,0 as x,y. So that's what I'll do.
                    x = (attr.cx||0) - attr.r;
                    y = (attr.cy||0) - attr.r;
                    w = h = attr.r * 2;
                    break;
    ...
    getPointAtSegmentLength = function (p1x, p1y, c1x, c1y, c2x, c2y, p2x, p2y, length) {
        var len = 0,
            precision = 10, // JD: Smoother animation on mobile devices
      ...
      return cache.data[i+1];
      /* JD: Sometimes raphael fails to correctly populate
       the first element in the length data. When that
       happens, this function fails to return a value.
       Return the next element in the cache as a workaround. */
    },
